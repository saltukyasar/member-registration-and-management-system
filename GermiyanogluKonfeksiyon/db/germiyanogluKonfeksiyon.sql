...
INSERT INTO `admin` (`ID`, `FullName`, `MobileNumber`, `Email`, `Password`, `RegDate`) VALUES
...
INSERT INTO `calisanlar` (`ID`, `FirstName`, `LastName`, `MobileNumber`, `Email`, `Address`, `CreationDate`) VALUES
